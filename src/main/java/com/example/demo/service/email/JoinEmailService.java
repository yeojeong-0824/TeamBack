...
public class JoinEmailService {
    ...
    private final Map<String, String> emailAuthedKeyMap = new HashMap<>();
    public void addEmailAuthedKeyMap(String email, String key) {
    ...
    public String createAuthedKeyForJoin() {
    ...
    public boolean checkAuthedKeyForJoin(String email, String key) {
    ...
    /**
     * 회원가입에 대한 이메일 인증여부 체크
     */
    // 회원가입 인증 이메일의 값이 Authed라면 인증된 사용자라는 것으로 간주함
    public boolean checkAuthedEmailForJoin(String email) {
